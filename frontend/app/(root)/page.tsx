      ...
      <section className="dark:bg-background-200/50 flex w-full flex-col items-center gap-8 border-y-2 border-dashed border-gray-700/50 bg-slate-100 px-4 py-28 sm:px-0">
        ...
        <div className="group flex flex-col items-center gap-2">
          <svg
            ...
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
            className="arrow text-brand-400 peer order-1 size-20 transition-transform duration-300 group-hover:-rotate-12"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
      ...
      <section className="relative mx-auto mt-20 flex w-full max-w-7xl flex-col items-center gap-6 px-4 md:mt-32 md:gap-8 md:px-6">
        ...
        <div id="features">
          <div className="mx-auto grid grid-cols-1 gap-6 sm:w-[80%] sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-background-400/20 rounded-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-muted text-center text-sm">
                  The loop that everyone loves and actually uses. While loops?
                  naaaaaa!
                </p>
              </div>
            </div>
            <div className="bg-background-400/20 rounded-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-muted text-center text-sm">
                  Curated built in functions that developers and programmers
                  want. We want them too.
                </p>
              </div>
            </div>
            <div className="bg-background-400/20 rounded-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-muted text-center text-sm">
                  An interpreter that uses python present already. Windows? just
                  download python.
                </p>
              </div>
            </div>
            <div className="bg-background-400/20 rounded-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-muted text-center text-sm">
                  A good lexer knows what is coming. Our lexer knows all of your
                  tokens.
                </p>
              </div>
            </div>
            <div className="bg-background-400/20 rounded-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-muted text-center text-sm">
                  A parser that knows what it is doing. Where to go , what to
                  look for.
                </p>
              </div>
            </div>
            <div className="bg-background-400/20 rounded-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-muted text-center text-sm">
                  Types are not something you should see, they are something you
                  should know.
                </p>
              </div>
            </div>
